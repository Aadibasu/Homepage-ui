  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      <div data-aos="fade-right"
        ...
        <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibod tracking-wider my-8'>
          🛰️ Next-Gen 
          <br/>
          AQI Tracking
        </h1>
          <p className='text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
            We use portable hardware stations (ESP32 + advanced sensors) that can be placed in vehicles, drones, or fixed spots to capture real-time AQI data. All data is seamlessly transmitted to our interactive web app, where users can track pollution levels anytime, anywhere.
            <br />
            <br />
            <br />
     ...
     data-aos-delay="300"
     data-aos-offset="0" data-aos-duration="2300" className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm"lfet-[2%] h-full' scene="https://prod.spline.design/FzIvJ6iIyT-zZkJR/scene.splinecode" />
    </main>
  )
}
